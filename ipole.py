...
# read in data 
i0, j0, Ia, Is, Qs, Us, Vs, tauF, dum, dum = np.loadtxt(fil, unpack=True)
...
plt.pcolormesh(i,j,z,cmap='coolwarm', vmin = -5, vmax = 5.)
plt.title('CP [%]')
plt.axis([-FOV/2,FOV/2,-FOV/2,FOV/2])
plt.colorbar()
